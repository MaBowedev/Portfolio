...
import aiImage from "../../../assets/Profile.png";
    ...
    const socialIcons = [
        {
            ...
            icon: (
                <FaFacebookF
                    onClick={() => router.push("https://www.facebook.com/?locale=it_IT")}
                    color="rgba(242, 40, 47)"
            ...
            <AnimationWrapper >
                <motion.div className={
                    ...
                    <div className="flex flex-col justify-center items-start row-start-2 sm:row-start-1">
                        ...
                        <p className="text-[#000] mt-4 mb-8 text-2xl font-bold">
                            {data && data.length ? data[0]?.summary : null}
                        </p>
                        <motion.div className="flex gap-8 cursor-pointer">
                    ...
                    <motion.div ref={containerRef} className="flex w-full justify-end">
                        <motion.div
                            ...
                            className="w-[400px] h-[400px] relative bg-orange-500"
                        >
